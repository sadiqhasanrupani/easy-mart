...
exports.getProductCategoriesHandler = exports.getProductHandler = exports.getAllProductsHandler = void 0;
    ...
    try {
        ...
        if (query.categoryId) {
            ...
            const getProducts = await db_config_1.default
                ...
                .where((0, drizzle_orm_1.eq)(schema_1.productCategory.id, categoryId));
...
async function getProductCategoriesHandler(_req, res) {
    try {
        //^ get all product categories
        const getProductCategories = await db_config_1.default
            .select({ id: schema_1.productCategory.id, name: schema_1.productCategory.name })
            .from(schema_1.productCategory)
            .orderBy((0, drizzle_orm_1.asc)(schema_1.productCategory.createdAt));
        return res
            .status(200)
...
exports.getProductCategoriesHandler = getProductCategoriesHandler;
