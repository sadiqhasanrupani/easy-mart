...
exports.insertDummyData = void 0;
...
async function insertDummyData() {
    try {
        ...
        const anyUsers = await db_config_1.default.select({ id: schema_1.user.id }).from(schema_1.user);
        if (!anyUsers[0]) {
            const insertUserData = await db_config_1.default.insert(schema_1.user).values([
                {
                    userName: "John Doe",
        ...
        const anyProductCategory = await db_config_1.default.select({ id: schema_1.productCategory.id }).from(schema_1.productCategory);
        if (!anyProductCategory[0]) {
            const insertProductCategory = await db_config_1.default.insert(schema_1.productCategory).values([
                {
                    id: 1,
                    name: "Electronics",
        ...
        const anyProducts = await db_config_1.default.select({ id: schema_1.product.id }).from(schema_1.product);
        if (!anyProducts[0]) {
            const insertProducts = await db_config_1.default.insert(schema_1.product).values([
                {
                    categoryId: 1,
                    name: "SmartPhone",
                    description: "Introducing our SmartPhone – your pocket-sized companion for staying connected and organized. With its advanced features and sleek design, it's perfect for multitasking and capturing moments on the go. Stay productive and entertained with our versatile SmartPhone.",
                    createdAt: (0, moment_1.default)().format("YYYY-MM-DD HH:mm:ss"),
                    updatedAt: (0, moment_1.default)().format("YYYY-MM-DD HH:mm:ss"),
                    price: "999.980",
                    image: [
                ...
                },
                {
                    categoryId: 1,
                    name: "Laptop",
                    description: "Introducing our sleek Laptop – your portable powerhouse for work and play. With cutting-edge technology and a lightweight design, it's perfect for staying productive on the go. Elevate your computing experience with our versatile Laptop.",
                    createdAt: (0, moment_1.default)().format("YYYY-MM-DD HH:mm:ss"),
                    updatedAt: (0, moment_1.default)().format("YYYY-MM-DD HH:mm:ss"),
                    price: "1499.990",
                    image: [
                ...
                },
                {
                    categoryId: 2,
                    name: "T-shirt",
                    description: "Introducing our classic T-shirt – the ultimate wardrobe staple for effortless style. With its comfortable fit and timeless design, it's perfect for any casual occasion. Upgrade your look with our versatile T-shirt.",
                    createdAt: (0, moment_1.default)().format("YYYY-MM-DD HH:mm:ss"),
                    updatedAt: (0, moment_1.default)().format("YYYY-MM-DD HH:mm:ss"),
                    price: "19.990",
                    image: [
                ...
                },
                {
                    categoryId: 2,
                    name: "Dress",
                    description: "Introducing our stylish Dress – your go-to choice for effortless elegance. With a flattering silhouette and timeless design, it's perfect for any occasion. Elevate your wardrobe with our versatile Dress.",
                    createdAt: (0, moment_1.default)().format("YYYY-MM-DD HH:mm:ss"),
                    updatedAt: (0, moment_1.default)().format("YYYY-MM-DD HH:mm:ss"),
                    price: "49.990",
                    image: [
                ...
                },
                {
                    categoryId: 3,
                    name: "Microwave Oven",
                    description: "Introducing our Microwave Oven – your kitchen's new best friend. With quick and efficient cooking capabilities, it heats up meals in seconds, making mealtime a breeze. Compact and versatile, it's perfect for busy households and small spaces. Simplify your cooking routine with our Microwave Oven.",
                    createdAt: (0, moment_1.default)().format("YYYY-MM-DD HH:mm:ss"),
                    updatedAt: (0, moment_1.default)().format("YYYY-MM-DD HH:mm:ss"),
                    price: "79.990",
                    image: [
                ...
                },
                {
                    categoryId: 1,
                    name: "Tablet",
                    description: "Introducing our sleek Tablet – your portable powerhouse for productivity and entertainment. With a vibrant touchscreen display, powerful performance, and long-lasting battery life, it's perfect for work or play on the go. Stay connected, organized, and entertained with ease.",
                    createdAt: (0, moment_1.default)().format("YYYY-MM-DD HH:mm:ss"),
                    updatedAt: (0, moment_1.default)().format("YYYY-MM-DD HH:mm:ss"),
                    price: "499.990",
                    image: [
                ...
                },
                {
                    categoryId: 3,
                    name: "Toaster",
                    description: "Introducing our innovative Toaster – the perfect appliance for busy mornings and delicious breakfasts. Designed for efficiency and convenience, this toaster makes it easy to enjoy crispy, golden toast every time. With multiple browning settings, you can customize your toast to your desired level of crunchiness. The extra-wide slots accommodate a variety of bread sizes and types, from thick slices of artisanal bread to bagels and English muffins. The built-in warming rack allows you to heat croissants or pastries while toasting your bread, making breakfast preparation a breeze. Sleek and compact, our toaster fits seamlessly into any kitchen decor, saving space on your countertop. Start your day off right with our reliable and stylish Toaster, and savor the perfect slice of toast with every use.",
                    createdAt: (0, moment_1.default)().format("YYYY-MM-DD HH:mm:ss"),
                    updatedAt: (0, moment_1.default)().format("YYYY-MM-DD HH:mm:ss"),
                    price: "34.990",
                    image: [
